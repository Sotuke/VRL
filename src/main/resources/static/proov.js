...
function saveToDB(){
    console.log("Saving ip:" +ip+ " to database");
    console.log("Screen size: "+window.browserInfo.screen);
    console.log("Browser: "+window.browserInfo.browser);
    console.log("Browser version: "+window.browserInfo.browserVersion);
    console.log("mobile: "+window.browserInfo.mobile);
    console.log("os: "+window.browserInfo.os);
    console.log("osVersion: "+window.browserInfo.osVersion);
